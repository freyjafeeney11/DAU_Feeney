...
inline Item GenerateItem(int itemId) {
    ...
    case ITEM_LETTER:     return Item(ITEM_LETTER, "Perfumed Letter", "It says: idk ill come up with something");
    case ITEM_FLASHDRIVE: return Item(ITEM_FLASHDRIVE, "FlashDrive", "I wonder what's on this...");
    case ITEM_PICTURE:    return Item(ITEM_PICTURE, "Old Photograph", "It's a photo of two people on a beach.");
    default:              return Item();
    }
}